        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <a href="adminInsertArticle" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Ajouter un nouvel article</span></a>
                        <a href="adminCreateCategory" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Ajouter une catégorie</span></a>
                        <a href="adminCreateSubCategory" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Ajouter une sous-catégorie</span></a>
                    </div>
                </div>
            </div>
