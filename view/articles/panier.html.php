...
<html lang="fr">
    ...
    <body>
        ...
        <h1 class="jumbotron-heading text-center">VOTRE PANIER</h1>

        <?php if ($products == array()) { echo "<div class='text-center pb-5'>Votre panier est vide.</div>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><b>Disponibilité</b></th>
                                    <th scope="col" class="text-center"><b>Quantité</b></th>
                                    <th scope="col" class="text-right"><b>Prix Hors Taxes</b></th>
                                    <th> </th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($products as $product) { echo "
                                    <form method='post' action='panier'>
                                        ...
                                        <td class='text-right'><a href='panier?del=".$product->id."' class='btn btn-sm btn-warning'><i class='fa fa-trash'></i></button></a> </td>
                                        </tr> 
                                    " ; }
                                ?> 
        ...
        <div class="col mb-2">
            ...
            <div class="row">
                <div class="col-sm-12  col-md-6">
                    <a class='a' href='produits'><button class="btn btn-lg btn-block btn-light text-uppercase">CONTINUER VOS ACHATS</button></a>
                </div>
                <div class="col-sm-12 col-md-6 text-right">
                    <a class='a' href='cartvalidation'><button class="btn btn-lg btn-block btn-dark text-uppercase">VALIDER LE PANIER</button></a>
                </div>
            </div>
        </div>
