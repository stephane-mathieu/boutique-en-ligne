    ...
    <div class="row">
        <div class="col-md-115 border-right">
            <div class="p-3 py-5">
                ...
                <form  method="POST">
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Mot de passe actuel</label><input type="password" class="form-control" placeholder="**********" name="actual_password"></div>
                        <div class="error"><?php if (isset($error_actual)) { echo $error_actual ; }?></div>

                        <div class="col-md-12"><label class="labels">Nouveau mot de passe</label><input type="password" class="form-control"  name="new_password"  placeholder="********** "></div>
                        <div class="error"><?php if (isset($error_new)) { echo $error_new ; }?></div>

                        <div class="col-md-12"><label class="labels">Confirmez votre nouveau mot de passe</label><input type="password"class="form-control"  name="confirm_new_password" placeholder="**********"></div>
